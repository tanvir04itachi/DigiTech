...
public class Product4 extends JFrame implements ActionListener
{
	...
	public Product4()
	{
		...
		lbl1 = new JLabel("Desktop 4");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("16.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Intel Core i5 10400F 8GB RAM, 256GB SATAII SSD Gaming Desktop PC");
