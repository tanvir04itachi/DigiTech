...
public class Payment extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			String cardNum = txt1.getText().trim();
			String cardName = txt2.getText().trim();
			String expDate = txt3.getText().trim();
			String cvv = txt4.getText().trim();
			
			if(cardNum.isEmpty() || cardName.isEmpty() || expDate.isEmpty() || cvv.isEmpty())
			{
				JOptionPane.showMessageDialog(this, "Please fill in all payment details!", "Validation Error", JOptionPane.WARNING_MESSAGE);
			}
			else
			{
				try
				{
					...
					fwriter.write("Card Number: " + cardNum + "\tName: " + cardName + "\tExpiry: " + expDate + "\tCVV: " + cvv + "\n");
					fwriter.flush();
					fwriter.close();
					
					JOptionPane.showMessageDialog(this, "Payment Successful! Details saved.", "Success", JOptionPane.INFORMATION_MESSAGE);
				...
				{
					JOptionPane.showMessageDialog(this, "File error occurred during saving payment.", "Error", JOptionPane.ERROR_MESSAGE);
					ioe.printStackTrace();
				}
			}
		}
