...
public class Product1 extends JFrame implements ActionListener
{
	...
	public Product1()
	{
		...
		lbl1 = new JLabel("Desktop 1");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("13.png"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Intel Core i3 10400F 8GB DDR4, 250GB SSD Standard Desktop PC");
