...
public class Product111 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product111()
	{
		...
		lbl1 = new JLabel("Monitor ");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("1.monitor.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("MSI G244F E2 23.8 inch FHD Rapid IPS 180Hz Gaming Monitor");
