...
public class Product66 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product66()
	{
		...
		lbl1 = new JLabel("Acer Aspire 3 ");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("6.png"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("A315-59-5031 Intel Core i5 1235U 8GB RAM 512GB SSD 15.6 Inch FHD Display Pure Silver Laptop");
