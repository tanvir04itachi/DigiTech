...
public class Product666 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product666()
	{
		...
		lbl1 = new JLabel("Mouse");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("1.mouse.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Fantech T533 Wired Premium Office Mouse");
