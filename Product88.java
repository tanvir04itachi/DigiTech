...
public class Product88 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product88()
	{
		...
		lbl1 = new JLabel("Apple MacBook Air Late 2020 ");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("10.png"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Apple M1 Chip 8GB RAM 256GB SSD 13.3 Inch Retina Display Touch ID Gold MacBook ");
        lbl3.setBounds(610, 230, 400, 40);
