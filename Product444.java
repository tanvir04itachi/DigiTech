...
public class Product444 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product444()
	{
		...
		lbl2 = new JLabel(new ImageIcon("1.cpu.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Intel 10th Gen Core i3 10100F Processor");
