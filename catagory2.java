...
public class catagory2 extends JFrame implements ActionListener
{
	...
	public catagory2()
	{
		...
		//d1
		btn1 = new JButton();
        btn1.setIcon(new ImageIcon("3.png"));
        btn1.setBounds(60, 160, 300, 220);
        btn1.setBackground(Color.white);
		btn1.addActionListener(this);
		panel.add(btn1);
       
        lbl1 = new JLabel("<html>Laptop 1<br>BDT 25000 tk</html>");
		...
		//d2
		btn2 = new JButton();
        btn2.setIcon(new ImageIcon("4.png"));
        btn2.setBounds(380, 160, 300, 220);
        btn2.setBackground(Color.white);
		btn2.addActionListener(this);
		panel.add(btn2);

        lbl2 = new JLabel("<html>Laptop 2<br>BDT 26000 tk</html>");
		...
		//d3
		btn3 = new JButton();
        btn3.setIcon(new ImageIcon("5.png"));
        btn3.setBounds(700, 160, 300, 220);
        btn3.setBackground(Color.white);
		btn3.addActionListener(this);
		panel.add(btn3);
       
        lbl3 = new JLabel("<html>Laptop 3<br>BDT 27000 tk</html>");
		...
		//d4
		btn4 = new JButton();
        btn4.setIcon(new ImageIcon("6.png"));
        ...
        lbl4 = new JLabel("<html>Laptop 4<br>BDT 28000 tk</html>");
        lbl4.setBounds(1020, 395, 300, 45);
        lbl4.setFont(new Font("Segoe UI", Font.PLAIN, 20));
		panel.add(lbl4);
		//d5
		btn5 = new JButton();
        btn5.setIcon(new ImageIcon("7.png"));
        ...
        lbl5 = new JLabel("<html>Laptop 5<br>BDT 28000 tk</html>");
		...
		//d6
		btn6 = new JButton();
        btn6.setIcon(new ImageIcon("8.png"));
        ...
        lbl6 = new JLabel("<html>Laptop 6<br>BDT 29000 tk</html>");
		...
		//d7
		btn7 = new JButton();
        btn7.setIcon(new ImageIcon("9.png"));
        ...
        lbl7 = new JLabel("<html>Laptop 7<br>BDT 30000 tk</html>");
		...
		//d8
		btn8 = new JButton();
        btn8.setIcon(new ImageIcon("10.png"));
        ...
        lbl8 = new JLabel("<html>Laptop 8<br>35000 tk</html>");
