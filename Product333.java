...
public class Product333 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product333()
	{
		...
		lbl2 = new JLabel(new ImageIcon("1.gpu.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Colorful GeForce GT710-2GD3-V 2GB Graphics Card");
