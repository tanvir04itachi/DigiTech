...
public class Uhome extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(ae.getSource() == b4 || ae.getSource() == l1)
		{
		catagory1 cat = new catagory1();
		cat.setVisible(true);
		this.setVisible(false);
		}		
		else if(ae.getSource() == b5 || ae.getSource() == l2)
		{
		catagory2 cat = new catagory2();
		cat.setVisible(true);
		this.setVisible(false);
		}		
		else if(ae.getSource() == b6 || ae.getSource() == l3)
		{
		catagory3 cat = new catagory3();
		cat.setVisible(true);
		this.setVisible(false);
		}		
		else if(ae.getSource() == b7 || ae.getSource() == l4)
		{
