...
public class Product555 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product555()
	{
		...
		lbl2 = new JLabel(new ImageIcon("1.ssd.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Adata SU650 120 GB Solid State Drive");
