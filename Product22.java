...
public class Product22 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product22()
	{
		...
		lbl1 = new JLabel("HP 15s-fq5486TU ");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("2.png"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Intel Core i3 1215U 4GB RAM 256GB SSD 15.6 Inch FHD Display Black Laptop");
