...
public class Product11 extends JFrame implements ActionListener
{
	...
	public Product11()
	{
		...
		lbl1 = new JLabel("HP 15s-eq2618AU ");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("01.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("AMD Ryzen 3 5300U 8GB RAM 512GB SSD 15.6 Inch HD Display Spruce Blue Laptop");
