...
public class Product2 extends JFrame implements ActionListener
{
	...
	public Product2()
	{
		...
		lbl1 = new JLabel("Desktop 2");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("14.png"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("AMD Ryzen Althon Pro, 4gb RAM, 512 gb ssd");
        lbl3.setBounds(610, 230, 290, 40);
