...
public class Product55 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product55()
	{
		...
		lbl2 = new JLabel(new ImageIcon("5.png"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("AMD Ryzen 5 7530U 8GB RAM 512GB SSD 15.6 Inch FHD Antiglare IPS Display Abyss Blue Laptop");
