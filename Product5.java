...
public class Product5 extends JFrame implements ActionListener
{
	...
	public Product5()
	{
		...
		lbl1 = new JLabel("Desktop 5");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("17.jpg"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Intel Core i5 11400F 8GB RAM, 512GB SATAII SSD Gaming Desktop PC");
