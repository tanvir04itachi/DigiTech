...
public class Product33 extends JFrame implements ActionListener
{
	JPanel panel;
	...
	public Product33()
	{
		...
		lbl1 = new JLabel("Asus VivoBook 15 X1502ZA");
		lbl1.setBounds(600,190,1400,40);
		lbl1.setFont(new Font("Segoe UI", Font.PLAIN, 22));
		panel.add(lbl1);
		 
		 
		lbl2 = new JLabel(new ImageIcon("3.png"));
		lbl2.setBounds(100,180,450,400);
		panel.add(lbl2);
		
		lbl3 = new JLabel("Intel Core i3 1215U 4GB RAM 256GB SSD 15.6 Inch FHD Display Terra Cotta Laptop");
